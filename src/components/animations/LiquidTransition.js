...
import {TweenMax, Power3, TimelineMax} from "gsap";
     ...
     const CanvasSlideshow = function( options ) {
      ...
      options.displaceScale       = options.hasOwnProperty('displaceScale') ? options.displaceScale : [2048, 2048];
      ...
      if ( options.autoPlay === true ) {
        ...
        ticker.add(function( delta ) {
          ...
          displacementSprite.rotation += 20.3;         
      ...
      var transitionAnimation = new PIXI.Ticker();
      ...
      if(options.scrollTransition){
          const getScrollNav = (e) => {
            ...
            document.addEventListener("wheel", getScrollNav, true);
      }else{
