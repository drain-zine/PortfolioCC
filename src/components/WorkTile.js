...
const WorkTile = ({data, incrementTogglesCounter, decrementTogglesCounter}) => {
    ...
    return(
            ...
            <FadeInDiv style={{width: width+"rem" , height: height+"rem", left: init[0]+"%", top: init[1]+"%"}} className="draggable tile absolute overflow-y-hidden" onDoubleClick={toggleWorkTile}>
