        ...
        <main className="pt-2 flex justify-center trolley">
            <div className="puzzle-container md:absolute md:top-1/2 md:transform md:-translate-y-1/2 md:w-1/2">
                 <div className="relative text-center">
                    <h1 className="primary-font-stack text-white xl:top-0 text-3xl" >Is this page a visual contraption? What hides underneath this name? Can I perhaps drag these elements around?</h1>
                ...
                <div className="piece p2 draggable"><img src={piece2}/></div><div className="link l2"><Link to="/ephemera" className="xl:text-2xl  lg:text-base md:text-xs">EPHEMERA</Link></div>
